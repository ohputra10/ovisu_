import $9nax8$nodefetch from "node-fetch";
import {Buffer as $9nax8$Buffer} from "buffer";



var $62208318282b33db$require$Buffer = $9nax8$Buffer;
class $62208318282b33db$export$b0afa329482d05c2 {
    queryParams = '';
    hashFragment = '';
    ...
    _token() {
        return `Basic ${$62208318282b33db$require$Buffer.from(`${this.user.user}:${this.user.passwd}`).toString('base64')}`;
    }
    _body(command) {
    ...
    request(command) {
        ...
        return $9nax8$nodefetch(this._makeUrl(), this.options);
    }
}


class $69ce010df1837563$export$8fdcabde73f49165 {
    ...
    _prettyStr(fields, data) {
        ...
        for(let i1 = 0; i1 < fields.length; i1++){
            ...
            else colSize.push(Math.max(fields[i1].columnName.length, $69ce010df1837563$var$suggestedMinWidths[fields[i1].size])); // max(column_name.length,suggest_column_with_suggestion)
        // console.log(colSize)
        }
 ...
 */ const $69ce010df1837563$var$typeNameMap = {
    0: 'null',
    1: 'bool',
    2: 'tinyint',
    3: 'smallint',
...
const $69ce010df1837563$var$suggestedMinWidths = {
    0: 4,
    1: 4,
    2: 4,
    3: 6,
...
class $6b7c5ca92d52c367$export$d86352e83c3b0e60 {
    constructor(options){
        this._uri = {
            host: options.host,
            path: options.path,
    ...
    async query(sql, pure = true) {
        let req = new $62208318282b33db$export$b0afa329482d05c2(this._uri, this._user);
        let response = await req.request(sql);
        if (response.status == 200) {
            let res_json = await response.json();
            if (pure == false) return new $69ce010df1837563$export$8fdcabde73f49165(res_json, sql);
            else return new $69ce010df1837563$export$8fdcabde73f49165(res_json);
...
class $350ef2af30b2fe60$export$3701362c0f56cd7b {
    constructor(connOption){
        this._connOption = connOption;
    }
    cursor() {
        return new $6b7c5ca92d52c367$export$d86352e83c3b0e60(this._connOption);
    }
}


let $c3f6c693698dc7cd$export$41c562ebe57d11e2 = {
    path: '/rest/sql/',
    scheme: 'http',
    user: 'root',
    passwd: 'taosdata',
...
let $c3f6c693698dc7cd$export$64605811ab45167f = function $c3f6c693698dc7cd$export$64605811ab45167f(option) {
    // console.log("index.options:"+JSON.stringify(option));
    return new $350ef2af30b2fe60$export$3701362c0f56cd7b(option);
};


export {$c3f6c693698dc7cd$export$41c562ebe57d11e2 as options, $c3f6c693698dc7cd$export$64605811ab45167f as connect};
